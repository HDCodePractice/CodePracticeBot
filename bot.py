...
if __name__ == '__main__':
    ...
    # 在这里加入功能
    from cmdproc import startcmd,rewardscmd,admincmd,weathercmd,infocmd,penaltiescmd,guesscmd,capitals,botadmincmd,solve24
    ...
    commands += solve24.add_handler(dispatcher)
