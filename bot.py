...
if __name__ == '__main__':
    ...
    # 在这里加入功能
    from cmdproc import startcmd,rewardscmd,admincmd,weathercmd,infocmd,penaltiescmd,guesscmd,capitals,botadmincmd,game24
    ...
    commands += game24.add_dispatcher(dispatcher)
